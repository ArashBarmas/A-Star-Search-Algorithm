...
RoutePlanner::RoutePlanner(RouteModel &model, float start_x, float start_y, float end_x, float end_y): m_Model(model) {
    ...
    //    to the starting and ending coordinates.
...
// TODO 6: Complete the ConstructFinalPath method to return the final path found from 
// your A* search.
// Tips:
// - This method should take the current (final) node as an argument and iteratively 
// follow the 
//   chain of parents of nodes until the starting node is found.
// - For each node in the chain, add the distance from the node to its parent to the 
// distance variable.
// - The returned vector should be in the correct order: the start node should be 
// the first element
